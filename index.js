      ...
      if( mission_state === "fwd") {
       ...
       pool.query(sql_chy,(error, results) => {
            ...
            if (Number(results.rows.length) == Number(mission_id) && mission_state === "fwd" && Number(mission_val) < Number(results.rows.length)) 
            {
               ...
               pool.query(sql_msc3,(error3, results3) => {
                ...
                `);
                    ...
                    // alert('Please answer all the tweets correctly! If there are no tweet number in this alert then you have not answered any tweet correctly yet. Correctly answered tweets IDs are '+R.pluck('question', data));
                   /*data.forEach(row => {
        ...
        if (Number(mission_val) >= Number(results.rows.length) ) {
            ...
            .tpaw0 iframe {position:absolute;width:100%;height:100%;overflow:hidden;}
            .tpaw0 iframe:-webkit-full-screen {min-height:1px !important;}
            .tpaw0preloaderOverlay {position:absolute;top:0;left:0;color:#373737;width:100%;height:100%;}
            .tpaw0preloaderOverlaycontent {width:100%;height:100%;}
            .tpaw0unavailableMessageOverlay {position:absolute;top:0;left:0;color:#373737;width:100%;height:100%;}
            .tpaw0unavailableMessageOverlaycontent {width:100%;height:100%;background:rgba(255, 255, 255, 0.9);font-size:0;margin-top:5px;}
            ...
            .s_DtaksTPAWidgetSkin iframe {position:absolute;width:100%;height:100%;overflow:hidden;}
            .s_DtaksTPAWidgetSkin iframe:-webkit-full-screen {min-height:1px !important;}
            .s_DtaksTPAWidgetSkinpreloaderOverlay {position:absolute;top:0;left:0;color:#373737;width:100%;height:100%;}
            .s_DtaksTPAWidgetSkinpreloaderOverlaycontent {width:100%;height:100%;}
            .s_DtaksTPAWidgetSkinunavailableMessageOverlay {position:absolute;top:0;left:0;color:#373737;width:100%;height:100%;}
            .s_DtaksTPAWidgetSkinunavailableMessageOverlaycontent {width:100%;height:100%;background:rgba(255, 255, 255, 0.9);font-size:0;margin-top:5px;}
            ...
            #rke15inlineContent-gridContainer > [id$="-rotated-wrapper"] > * {
                pointer-events: auto;
            }</style><div id="rke15inlineContent-gridWrapper" data-mesh-internal="true"><div id="rke15inlineContent-gridContainer" data-mesh-internal="true"><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:610px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ryq20"><h6 class="font_6">Practice </h6> <strong>Persuasion is the attempt to influence someone's belief,attitude, and intentions.</strong></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:601px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8rw8tn"><p class="font_8" style="font-size:15px; line-height:1.3em;"><span style="font-weight:bold;"><span style="letter-spacing:0.03em;"><span style="font-family:avenir-lt-w01_35-light1475496,sans-serif;"><span style="font-size:15px;"><span style="color:#000000;"></span></span></span></span></span></p>
            
            <p class="font_8" style="font-size:15px; line-height:1.3em;"><span style="letter-spacing:0.03em;"><span style="font-family:avenir-lt-w01_35-light1475496,sans-serif;"><span style="font-size:15px;"><span style="color:#000000;"> </span></span></span></span></p></div><div id="comp-kfb3ktl2" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a  id="comp-kfb3ktl2link" class="b4link"><span id="comp-kfb3ktl2label" class="b4label"></span></a></div><div id="comp-kfb3m2tz" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a  id="comp-kfb3m2tzlink" class="b4link"><span id="comp-kfb3m2tzlabel" class="b4label">Tweet ID: `+fin_q+`</span></a></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:42px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kfpyrzoh"></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:310px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tjsl3"><h6 class="font_6">Introduction</h6></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tp69s"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">Definition {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tkx3g"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank"><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">About the task {link will open in new tab}</span></span></span></span></span></a></span></h2></div><div class="style-kf8s5xvn_left-direction style-kf8s5xvn" style="top:;bottom:;left:;right:;width:469px;height:110px;position:" data-state="valid" id="comp-kf8s5xt9"><label style="padding-left:0;padding-right:20px;display:none;margin-bottom:14px;text-align:left;direction:ltr" for="comp-kf8s5xt9textarea" id="comp-kf8s5xt9label" class="style-kf8s5xvnlabel"></label><textarea style="padding-left:16px;padding-right:10px" placeholder="" readonly="" class="has-custom-focus style-kf8s5xvntextarea" id="comp-kf8s5xt9textarea">`+tweet_text+`</textarea></div><div id="comp-kf8sqbal-rotated-wrapper" data-mesh-internal="true"><div id="comp-kf8sqbal" style="top:;bottom:;left:;right:;width:480px;height:28px;position:" data-angle="270"><button type="button" aria-label="Introduction" class="stylablebutton643855516__root style-kf8sqbcc__root" style="position:absolute" id="comp-kf8sqbal-inner-button"><div class="stylablebutton643855516__container"><span class="stylablebutton643855516__label">Introduction</span><span class="stylablebutton643855516__icon" aria-hidden="true"><div><svg data-bbox="13.05 2.55 33.878 54.8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
                <g>
                    <path d="M46.5 28.9L20.6 3c-.6-.6-1.6-.6-2.2 0l-4.8 4.8c-.6.6-.6 1.6 0 2.2l19.8 20-19.9 19.9c-.6.6-.6 1.6 0 2.2l4.8 4.8c.6.6 1.6.6 2.2 0l21-21 4.8-4.8c.8-.6.8-1.6.2-2.2z"/>
                </g>
            </svg>
            </div></span></div></button></div></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tqtc5"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">Example {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tred7"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">Trigger Alert {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ts8az"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">What you should consider {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tsu8k"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">What you need to ask yourself {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ttbhv"></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ttcnw"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;"></span></span></span></span></a></span></h2></div><div id="comp-kfvfyyya" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a  id="comp-kfvfyyyalink" class="b4link"><span id="comp-kfvfyyyalabel" class="b4label"></span></a></div><div id="comp-kfvfz7nq" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a id="comp-kfvfz7nqlink" class="b4link"><span id="comp-kfvfz7nqlabel" class="b4label"></span></a></div><div id="comp-kfvfzeot" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a id="comp-kfvfzeotlink" class="b4link"><span id="comp-kfvfzeotlabel" class="b4label"></span></a></div><div id="comp-kfvfzr63" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a id="comp-kfvfzr63link" class="b4link"><span id="comp-kfvfzr63label" class="b4label"></span></a></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:20px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kfvg3jl5"><p class="font_10"><span style="font-weight:bold;"><span style="color:#000000;"></span></span></p></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tv20d"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">How to report {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:330px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8s6j8x"><p class="font_8" style="font-size:15px; line-height:1.3em;"><span style="font-weight:bold;color:#000000;">`+foot_note+`<span style="letter-spacing:0.03em;"><span style="font-family:avenir-lt-w01_35-light1475496,sans-serif;"><span style="font-size:15px;"><span style="color:#000000;"></span></span></span></span></span></p></div><div id="comp-kfvfxgp6" data-align="center" data-disabled="true" data-margin="0" data-should-use-flex="true" data-width="42" data-height="35" style="top:;bottom:;left:;right:;width:42px;height:35px;position:" class="b1" data-state="desktop shouldUseFlex center"><a  id="comp-kfvfxgp6link" class="g-transparent-a b1link"><span id="comp-kfvfxgp6label" class="b1label">Yes</span></a></div><div id="comp-kfvfxk97" data-align="center" data-disabled="true" data-margin="0" data-should-use-flex="true" data-width="40" data-height="35" style="top:;bottom:;left:;right:;width:40px;height:35px;position:" class="b1" data-state="desktop shouldUseFlex center"><a  id="comp-kfvfxk97link" class="g-transparent-a b1link"><span id="comp-kfvfxk97label" class="b1label">No</span></a></div><div id="comp-kf8sfbtj" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="131" data-height="35" style="top:;bottom:;left:;right:;width:161px;height:65px;position:" class="b1" data-state="desktop shouldUseFlex center"><a target="_self" onclick="href='/maintask/?&workerId='+'`+workerID+`'+'&task_type='+'`+task+`'+'&block='+'`+block+`'+'&missionVal=0'+'&missionId=0'+'&mission_state=newreq'" id="comp-kf8sfbtjlink" class="g-transparent-a b1link"><span id="comp-kf8sfbtjlabel" class="b1label">Practice Complete. </BR>Proceed to Task</span></a></div><div class="style-kf8s5xvn_left-direction style-kf8s5xvn" style="top:;bottom:;left:;right:;width:460px;height:85px;position:" data-state="valid" id="comp-kfpx9ii3"><label style="padding-left:0;padding-right:20px;display:none;margin-bottom:14px;text-align:left;direction:ltr" for="comp-kfpx9ii3textarea" id="comp-kfpx9ii3label" class="style-kf8s5xvnlabel"></label><textarea style="padding-left:16px;padding-right:10px" placeholder="" class="has-custom-focus style-kf8s5xvntextarea" id="comp-kfpx9ii3textarea">`+Mrinal+`</textarea></div></div></div></div></div></div></div></div></main><div id="soapAfterPagesContainer" class="page-without-sosp"><style id="soapAfterPagesContainer-mesh-styles">
...
</div><div id="comp-kfb3ktl2" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a target="_self" href="" onclick="href='?&workerId='+'`+workerID+`'+'&missionVal='+'`+mission_val+`'+'&missionId='+'`+mission_id+`'+'&block='+'`+block+`'+'&task_type='+'`+task+`'+'&mission_state=fwd'+'&ans_n='+'&ans_y='" id="comp-kfb3ktl2link" class="b4link"><span id="comp-kfb3ktl2label" class="b4label"></span></a></div><div id="comp-kfb3m2tz" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="30" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a  id="comp-kfb3m2tzlink" class="b4link"><span id="comp-kfb3m2tzlabel" class="b4label">Tweet ID: `+fin_q+`</span></a></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:42px;height:auto;position:;pointer-events:none" class="txtNew" id="comp-kfpyrzoh"></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:310px;height:auto;position:;pointer-events:none" class="txtNew" id="comp-kf8tjsl3"><h6 class="font_6">Introduction</h6></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:auto;position:;pointer-events:none" class="txtNew" id="comp-kf8tp69s"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">Definition {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:auto;position:;pointer-events:none" class="txtNew" id="comp-kf8tkx3g"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank"><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">About the task {link will open in new tab}</span></span></span></span></span></span></a></span></h2></div><div class="style-kf8s5xvn_left-direction style-kf8s5xvn" style="top:;bottom:;left:;right:;width:469px;height:110px;position:" data-state="valid" id="comp-kf8s5xt9"><label style="padding-left:0;padding-right:20px;display:none;margin-bottom:14px;text-align:left;direction:ltr" for="comp-kf8s5xt9textarea" id="comp-kf8s5xt9label" class="style-kf8s5xvnlabel"></label><textarea style="padding-left:16px;padding-right:10px" placeholder="" readonly="" class="has-custom-focus style-kf8s5xvntextarea" id="comp-kf8s5xt9textarea">`+tweet_text+`</textarea></div><div id="comp-kf8sqbal-rotated-wrapper" data-mesh-internal="true"><div id="comp-kf8sqbal" style="top:;bottom:;left:;right:;width:480px;height:28px;position:" data-angle="270"><button type="button" aria-label="Introduction" class="stylablebutton643855516__root style-kf8sqbcc__root" style="position:absolute" id="comp-kf8sqbal-inner-button"><div class="stylablebutton643855516__container"><span class="stylablebutton643855516__label">Introduction</span><span class="stylablebutton643855516__icon" aria-hidden="true"><div><svg data-bbox="13.05 2.55 33.878 54.8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
             <g>
                 <path d="M46.5 28.9L20.6 3c-.6-.6-1.6-.6-2.2 0l-4.8 4.8c-.6.6-.6 1.6 0 2.2l19.8 20-19.9 19.9c-.6.6-.6 1.6 0 2.2l4.8 4.8c.6.6 1.6.6 2.2 0l21-21 4.8-4.8c.8-.6.8-1.6.2-2.2z"/>
             </g>
         </svg>
         </div></span></div></button></div></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:2px;position:;pointer-events:none" class="txtNew" id="comp-kf8tqtc5"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">Example {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tred7"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank"><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">Trigger Alert {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:320px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ts8az"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank"><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">What you should consider {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:380px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tsu8k"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank" ><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">What you need to ask yourself {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ttbhv"></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8ttcnw"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank"><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;"></span></span></span></span></a></span></h2></div><div id="comp-kfvfyyya" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a  id="comp-kfvfyyyalink" class="b4link"><span id="comp-kfvfyyyalabel" class="b4label"></span></a></div><div id="comp-kfvfz7nq" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a id="comp-kfvfz7nqlink" class="b4link"><span id="comp-kfvfz7nqlabel" class="b4label"></span></a></div><div id="comp-kfvfzeot" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:42px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a id="comp-kfvfzeotlink" class="b4link"><span id="comp-kfvfzeotlabel" class="b4label"></span></a></div><div id="comp-kfvfzr63" data-align="center" data-disabled="false" data-margin="0" data-should-use-flex="true" data-width="42" data-height="40" style="top:;bottom:;left:;right:;width:30px;height:40px;position:" class="b4" data-state="desktop shouldUseFlex center"><a id="comp-kfvfzr63link" class="b4link"><span id="comp-kfvfzr63label" class="b4label"><form>
<select name="list" id="list" accesskey="target">
    <option value='none' selected>Jump to ID</option>
    `+optionList+`
</select>
<input type=button value="Go" onclick="goToNewPage()" />
</form></span></a></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:20px;height:auto;position:;pointer-events:none" class="txtNew" id="comp-kfvg3jl5"><p class="font_10"><span style="font-weight:bold;"></br></br></br></br></br><span style="color:#000000;"></span></span></p></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:259px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8tv20d"><h2 class="font_2" style="font-size:13px;"><span style="font-size:13px;"><a href="" onclick="href='/home1/?task_type='+'`+task+`'" target="_blank"><span style="font-size:13px;"><span style="font-family:futura-lt-w01-book,sans-serif;"><span style="color:#292929;"><span style="text-decoration:underline;">How to report {link will open in new tab}</span></span></span></span></a></span></h2></div><div data-packed="true" data-vertical-text="false" style="top:;bottom:;left:;right:;width:330px;height:1px;position:;pointer-events:none" class="txtNew" id="comp-kf8s6j8x"><p class="font_8" style="font-size:15px; line-height:1.3em;"><span style="font-weight:bold;color:#000000;">`+foot_note+`<span style="letter-spacing:0.03em;"><span style="font-family:avenir-lt-w01_35-light1475496,sans-serif;"><span style="font-size:15px;"><span style="color:#000000;"></span></span></span></span></span></p></div><div id="comp-kfvfxgp6" data-align="center" data-disabled="`+yes_val+`" data-margin="0" data-should-use-flex="true" data-width="42" data-height="30" style="top:;bottom:;left:;right:;width:42px;height:30px;position:" class="b1" data-state="desktop shouldUseFlex center"><a target="_self" href="" onclick="href='?ans_y=YES'+'&ans_n='+'&workerId='+'`+workerID+`'+'&task_type='+'`+task+`'+'&block='+'`+block+`'+'&missionVal='+'`+mission_val+`'+'&missionId='+'`+mission_id+`'+'&mission_state=chk'" id="comp-kfvfxgp6link" class="g-transparent-a b1link"><span id="comp-kfvfxgp6label" class="b1label">Yes</span></a></div><div id="comp-kfvfxk97" data-align="center" data-disabled="`+no_val+`" data-margin="0" data-should-use-flex="true" data-width="40" data-height="30" style="top:;bottom:;left:;right:;width:40px;height:30px;position:" class="b1" data-state="desktop shouldUseFlex center"><a target="_self" href="" onclick="href='?ans_n=NO'+'&ans_y='+'&workerId='+'`+workerID+`'+'&block='+'`+block+`'+'&task_type='+'`+task+`'+'&missionVal='+'`+mission_val+`'+'&missionId='+'`+mission_id+`'+'&mission_state=chk'" id="comp-kfvfxk97link" class="g-transparent-a b1link"><span id="comp-kfvfxk97label" class="b1label">No</span></a></div><div id="comp-kf8sfbtj" data-align="center" data-disabled="`+sbmtval_efct+`" data-margin="0" data-should-use-flex="true" data-width="131" data-height="35" style="top:;bottom:;left:;right:;width:131px;height:35px;position:" class="b1" data-state="desktop shouldUseFlex center"><a target="_self" href="" onclick="href='?&workerId='+'`+workerID+`'+'&block='+'`+block+`'+'&task_type='+'`+task+`'+'&missionVal='+'`+mission_val+`'+'&missionId='+'`+mission_id+`'+'&mission_state='+'`+sbmtlnk+`'" id="comp-kf8sfbtjlink" class="g-transparent-a b1link"><span id="comp-kf8sfbtjlabel" class="b1label">`+sbmtval+`</span></a></div><div class="style-kf8s5xvn_left-direction style-kf8s5xvn" style="top:;bottom:;left:;right:;width:480px;height:155px;position:" data-state="valid" id="comp-kfpx9ii3"><label style="padding-left:0;padding-right:20px;display:none;margin-bottom:14px;text-align:left;direction:ltr" for="comp-kfpx9ii3textarea" id="comp-kfpx9ii3label" class="style-kf8s5xvnlabel"></label><textarea readonly style="padding-left:16px;padding-right:10px" placeholder="" class="has-custom-focus style-kf8s5xvntextarea" id="comp-kfpx9ii3textarea">`+Mrinal+`</textarea></div></div></div></div></div></div></div></div></main><div id="soapAfterPagesContainer" class="page-without-sosp"><style id="soapAfterPagesContainer-mesh-styles">
         ...
         #soapAfterPagesContainerinlineContent-gridContainer > [id$="-rotated-wrapper"] > * {
             pointer-events: auto;
         }</style><div id="soapAfterPagesContainerinlineContent-gridWrapper" data-mesh-internal="true"><div id="soapAfterPagesContainerinlineContent-gridContainer" data-mesh-internal="true"><div data-border-width="1px" style="transform-origin:center 0.5px;left:0;margin-left:0;width:100%;min-width:initial;top:;bottom:;right:;height:5px;position:;display:none" class="style-jr9629o5" id="comp-j1rtn0ml"></div><div style="width:;height:1px;top:;bottom:;left:;right:;position:;display:none" class="style-k6auwcww" id="CONTROLLER_COMP_CUSTOM_ID"></div></div></div></div><footer style="bottom:auto;left:0;margin-left:0;width:100%;min-width:980px;top:;right:;position:;display:none" class="style-k7ugjln5_footer style-k7ugjln5" tabindex="-1" data-site-width="980" data-fixedposition="false" data-isrunninginmobile="false" data-is-absolute-layout="false" data-state=" " id="SITE_FOOTER"><div style="left:0;width:100%" id="SITE_FOOTERscreenWidthBackground" class="style-k7ugjln5screenWidthBackground"><div class="style-k7ugjln5_bg"></div></div><div style="width:100%" id="SITE_FOOTERcenteredContent" class="style-k7ugjln5centeredContent"><div style="margin-left:calc((100% - 980px) / 2);width:980px" id="SITE_FOOTERbg" class="style-k7ugjln5bg"></div><div id="SITE_FOOTERinlineContent" class="style-k7ugjln5inlineContent"><style id="SITE_FOOTER-mesh-styles">
      ...
      //find task_type_val
        ...
        if( mission_state === "fwd") {
         ...
         pool.query(sql_chy,(error, results) => {
           ...
           mission_valcmp=mission_val++;
          if (Number(mission_valcmp) >= Number(results.rows.length) ) {
            ...
            if( mission_state === "newreq") {       
             ...
             mission_id_real = mission_id;
             --mission_id_real;
             var sql_chy1 = `insert into session values ('${workerID}','Main Task',${block},${task},${mission_id_real},'${k_ans}');` 
